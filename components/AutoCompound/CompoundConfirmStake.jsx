...
export const CompoundConfirmStake = (props) => {
  const {
    close,
    contractCall,
    isUnstaking,
  ...
  const shareTwitter = () => {
    ...
    }%20${stakeAmount.toString()}%20ApeCoin%20Auto-Compounding%20Pool%20on%20apecoinstaking.io!&hashtags=nf3%2Capecoin%2Capecoinstaking&url=${site}`;
      ...
      {!isSuccess ? (
        ...
        >
          ...
          >
            ...
            {isUnstaking ? "from" : "in"} the Auto-Compounding Pool. (1.0% fee is taken during compound.)
          </Box>
          <Button
